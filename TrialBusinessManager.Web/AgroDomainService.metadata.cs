...
namespace TrialBusinessManager.Web
{
    ...
    public partial class BillPayment
    {
        ...
        internal sealed class BillPaymentMetadata
        {
            ...
            public string MoneyReciept { get; set; }
    ...
    public partial class DueInfo
    {
        ...
        internal sealed class DueInfoMetadata
        {
            ...
            public float TransportationLoss { get; set; }

            public float SalesReturn { get; set; }

            public float Paid { get; set; }

            public float CommissionOnSell { get; set; }

            public float CommissionOnBenefit { get; set; }
    ...
    public partial class Employee
    {
        ...
        internal sealed class EmployeeMetadata
        {
            ...
            public EntityCollection<TransferIndent> TransferIndents { get; set; }

            public EntityCollection<ProductTransfer> ProductTransfers { get; set; }
    ...
    public partial class Indent
    {
        ...
        internal sealed class IndentMetadata
        {
            ...
            public long ForwardedToInventoryId { get; set; }
        }
    }
    ...
    public partial class Product
    {
        ...
        internal sealed class ProductMetadata
        {
            ...
            public EntityCollection<TransferIndentDetail> TransferIndentDetails { get; set; }

            public EntityCollection<DueInfo> DueInfoes { get; set; }

            public EntityCollection<IndentProductInfo> IndentProductInfoes { get; set; }

            public EntityCollection<ProductTransfer> ProductTransferDetails { get; set; }
    ...
    // The MetadataTypeAttribute identifies ProductTransferMetadata as the class
    // that carries additional metadata for the ProductTransfer class.
    [MetadataTypeAttribute(typeof(ProductTransfer.ProductTransferMetadata))]
    public partial class ProductTransfer
    {

        // This class allows you to attach custom attributes to properties
        // of the ProductTransfer class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class ProductTransferMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private ProductTransferMetadata()
            {
            }

            public long ProductTransferID { get; set; }

            public string ProductTransferCode { get; set; }

            [Include]
            public Inventory Inventory { get; set; }

            public long SendFromInventoryId { get; set; }

            public TransferIndent TransferIndent { get; set; }

            public long TransferIndentId { get; set; }

            [Include]
            public Employee Employee { get; set; }

            public long IssuedByDOId { get; set; }

            public DateTime DateOfIssue { get; set; }

            public long RecievedToInventoryId { get; set; }

            public long RecievedBySICId { get; set; }
            ...
            public string ProductTransferStatus { get; set; }
            [Include]
            public EntityCollection<ProductTransferDetail> ProductTransferDetails { get; set; }
        }
    }

    // The MetadataTypeAttribute identifies ProductTransferDetailMetadata as the class
    // that carries additional metadata for the ProductTransferDetail class.
    [MetadataTypeAttribute(typeof(ProductTransferDetail.ProductTransferDetailMetadata))]
    public partial class ProductTransferDetail
    {

        // This class allows you to attach custom attributes to properties
        // of the ProductTransferDetail class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class ProductTransferDetailMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private ProductTransferDetailMetadata()
            {
            }
    ...
    public partial class RegionTarget
    {
        ...
        internal sealed class RegionTargetMetadata
        {
            ...
            public double TransportationLossQuantity { get; set; }
    ...
    public partial class SalesReturn
    {
        ...
        internal sealed class SalesReturnMetadata
        {
            ...
            public long SendToInventoryId { get; set; }
        }
    }
    ...
    // The MetadataTypeAttribute identifies SeasonMetadata as the class
    // that carries additional metadata for the Expenditure class.
    [MetadataTypeAttribute(typeof(Season.SeasonMetadata))]
    public partial class Season
    {
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class SeasonMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private SeasonMetadata()
            {
            }
    ...
    // The MetadataTypeAttribute identifies TransferIndentMetadata as the class
    // that carries additional metadata for the TransferIndent class.
    [MetadataTypeAttribute(typeof(TransferIndent.TransferIndentMetadata))]
    public partial class TransferIndent
    {

        // This class allows you to attach custom attributes to properties
        // of the TransferIndent class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class TransferIndentMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private TransferIndentMetadata()
            {
            }
            ...
            public string TransferIndentCode { get; set; }
            [Include]
            public Inventory Inventory { get; set; }

            public long IssuedFromInventoryId { get; set; }
            ...
            public long IssuedToInventoryId { get; set; }

            public long IssuedToSICId { get; set; }

            public long ApprovedByNSMId { get; set; }
        }
    }

    // The MetadataTypeAttribute identifies TransferIndentDetailMetadata as the class
    // that carries additional metadata for the TransferIndentDetail class.
    [MetadataTypeAttribute(typeof(TransferIndentDetail.TransferIndentDetailMetadata))]
    public partial class TransferIndentDetail
    {

        // This class allows you to attach custom attributes to properties
        // of the TransferIndentDetail class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class TransferIndentDetailMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private TransferIndentDetailMetadata()
            {
            }
            ...
            public double PlacedProductQuantity { get; set; }

            public double ApprovedProductQuantity { get; set; }
        }
    }
    ...
    public partial class YearSummaryInventoryProduct
    {
        ...
        internal sealed class YearSummaryInventoryProductMetadata
        {
            ...
            public double ProductReturnQuantity { get; set; }
            ...
            public double ProductTransferFromQuantity { get; set; }

            public double ProductTransferToQuantity { get; set; }

            public double TransferFromAmount { get; set; }
