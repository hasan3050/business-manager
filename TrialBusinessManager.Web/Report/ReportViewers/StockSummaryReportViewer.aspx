<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockSummaryReportViewer.aspx.cs" Inherits="TrialBusinessManager.Web.Report.ReportViewers.StockSummaryReportViewer" %>
...
<body>
    ...
    <div style="font-family: 'Trebuchet MS'">
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" AppendDataBoundItems="True" 
            ...
            DataValueField="ProductId" Width="195px" Height="26px">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="ViewReportBtn" runat="server" Height="32px" 
                        onclick="ViewReportBtn_Click" Text="View Report" Width="141px" />
                </td>
            </tr>
        </table>
    ...
    <rsweb:ReportViewer ID="InventoryLogReport" runat="server" Font-Names="Verdana" 
        ...
        WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1250px" 
        Height="450px">
        <LocalReport ReportPath="Report\Designs\StockSummaryReportDesign.rdlc">
            <DataSources>
                <rsweb:ReportDataSource DataSourceId="InventoryLogDataSource" 
                    Name="StockSummaryDataSet" />
            </DataSources>
        </LocalReport>
    </rsweb:ReportViewer>
    <asp:ObjectDataSource ID="InventoryLogDataSource" runat="server" 
        SelectMethod="GetStockSummary" 
        TypeName="TrialBusinessManager.Web.AgroDomainService">
        <SelectParameters>
