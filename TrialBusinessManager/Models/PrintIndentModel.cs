...
{
    public class PrintIndentModel:ViewModelBase
    {
        /// <summary>
        ...
        private IndentProductInfo _info  ;
        ...
        public Double TotalQuantity
        {
            get
            {
                return Info.ProductQuantity*Product.StockKeepingUnit;
            }
        ...
        public Double TotalPrice
        {
            get
            {
                return Info.ProductQuantity*Product.StockKeepingUnit*Info.ProductPrice;
            }
        ...
        public Double NetPrice
        {
            get
            {
                return TotalPrice*((100-Info.CommissionPercentage)/100);
            }
